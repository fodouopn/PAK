...
if (isset($_POST['submit'])) {
    ...
    if (strlen($_POST['username']) < 1) {
        ...
        $con="UPDATE `users` SET `password`='$pass' WHERE`username`='$username'";
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrer email">
                            </div>
                            <div class="form-group">
