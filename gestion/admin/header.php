...
if (!isset($_SESSION['mail']) || !isset($_SESSION['nom']) || !isset($_SESSION['poste'])) {
    $_SESSION['error'] = "connexion forcée";
    ...
    <div id="top-nav" class="navbar navbar-inverse navbar-static-top" style="background-color:">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">Logiciel de Management de chantier</a>
            </div>
