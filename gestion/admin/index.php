...
if (isset($_POST['submit'])) {
    ...
    if (strlen($_POST['email']) < 1) {
        ...
        $sql = "SELECT * from utilisateurs where mail = '$email' and poste = 'admin'";
        $res = $db->query($sql);
        if ($res->num_rows < 1) {
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrer email">
                            </div>
                            <div class="form-group">
