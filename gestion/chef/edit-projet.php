                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="project-name" class="form-control" value="<?php echo $project->project_name ?>" aria-describedby="emailHelp" placeholder="Entrer le nom de la tache">
                        </div>
                          <div class="form-group">
                        ...
                        <div class="form-group" style="float: right">
                            ...
                            <a href=""><button type="button" class="btn btn-primary">Annuler</button>
                        </div>
