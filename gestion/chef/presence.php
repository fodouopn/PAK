...
echo "<script>window.location.href ='presence.php'</script>";
        } else {
...
<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
    <span class="fa fa-dashboard"> <a href="./attendences-index.php">Retour/</span> </a>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group" style="float: right">
                            ...
                            <a href="attendences-index.php"><button type="button" class="btn btn-primary">Annuler</button>
                        </div>
